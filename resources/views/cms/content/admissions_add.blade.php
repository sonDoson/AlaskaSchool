...
{!! $return !!}
@endif
<h2 id="title" >Thêm Bài Viết Tuyển Dụng</h2>
<div class="wrap-inline-block">
<div class="box form">
    <form method="POST" action="" enctype="multipart/form-data">
        <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
        <input type="hidden" name="id_category" id="csrf-token" value="1" />
        <input type="hidden" name="id_posts" value="" />
        <table>
        <tr>
            <td class="post-td" style="width: 140px;"><label>Tên Bài Viết: </label></td>
            <td class="post-td">
                <input class="input-style" type="text" name="name[vn]" placeholder="" />
                <input class="input-style" type="text" name="name[en]" placeholder="" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="post-td">
                <textarea style="width: 400px" type="text" name="sub[vn]" ></textarea>
            </td>
        </tr>
        <tr>
