...
{!! $return !!}
@endif
<h2 id="title" >Thêm Bài Viết 360</h2>
...
<div class="box form">
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td class="post-td">
                <select id="category" value="{{ $db_item['id_category'] }}" name="category" style="min-width: 200px;">
        ...
        <table>
        <tr>
            <td class="post-td" style="width: 140px;" ><label>Subtitle Tiếng Việt: </label></td>
            <td class="post-td">
        ...
        <button class="btn btn-submit">Sửa <i class="fas fa-check"></i></button>
    </form>
</div>
</div>
<!--javascript-->
...
<script>
    $().ready(function(){
        var id_category = $("#category").attr('value');
