    ...
    <div class="content">
        ...
        <div class="section" id="section-1">
            ...
            @for($i=0; $i < sizeof($section_1[key($section_1)]); $i++)
                ...
                @if(isset($section_1[key($section_1)][$i]['images'][0]))
                    <div class="big-news-item-image" style="background-image:url({{ $section_1[key($section_1)][$i]['images'][0] }})"></div>
                @else
                    <div class="big-news-item-image" style="background-image: url('../../../uploads/logo/background.png')"></div>
                @endif
            ...
            @for($i=0; $i < 4; $i++)
                ...
                <div class="big-news-item">
                @if(isset($section_1[key($section_1)][$i]['images'][0]))
                    <div class="big-news-item-image" 
                    style="background-image:url({{ $section_1[key($section_1)][$i]['images']['thumbnail'] }})"></div>
                @else
                    <div class="big-news-item-image" 
                    style="background-image: url('../../../uploads/logo/background.png')"></div>
                @endif
                    <div class="big-news-item-content font-resize">
                        <h4>{!! $section_1[key($section_1)][$i][$lang[0]] !!}</h4>
                        <div class="big-news-item-content-text">
        ...
        <div id="back-section-2">
            ...
            <div class="section-2-slider" style="width: {{ sizeof($section_2) * 240 + 10}}px !important;" value="{{ sizeof($section_2) }}">
                ...
                @if(isset($value['images'][0]))
                    <div class="section-2-slider-image" 
                        style="overflow: hidden;background-image:url({{ $value['images']['thumbnail'] }})">
                    </div>
                @else
                    <div class="section-2-slider-image" 
                        style="overflow: hidden;background-color:#ffd2ad;background-image: url('../../../uploads/logo/background.png');">
                    </div>
                @endif
        ...
        <div class="section" id="message-box">
            ...
            @foreach($section_3[0] as $key => $value)
                ...
                @else
                    <div class="message-box-item-image" style="background-image:url('../../../uploads/logo/background.png')">
                @endif
